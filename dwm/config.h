...
static const char *pmenucmd[] = { "rofi", "-show", "power-menu", "-modi", "power-menu:~/.local/bin/rofi-power-menu" };
static const char *screenshotcmd[] = {"gnome-screenshot", "-d", "3", NULL};
static const char *termcmd[]  = { "xterm", NULL };

static Key keys[] = {
	/* modifier                     key        function        argument */
	{ MODKEY,                       XK_Escape, spawn,          {.v = dmenucmd } },
	{ MODKEY|ShiftMask,             XK_Escape, spawn,          {.v = pmenucmd } },
